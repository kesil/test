...
const SONGS = {
  ...
  dawn: {
    bpm: 92,
    ch: [
      { type: 'triangle', vol: 0.26, notes: [[41,4],[45,4],[48,4],[45,4],[43,4],[48,4],[50,4],[48,4]] },
      { type: 'square', vol: 0.07, notes: [[65,2],[0,2],[69,2],[72,2],[0,2],[69,2],[67,4],[0,4], [65,2],[0,2],[72,2],[74,2],[0,2],[72,2],[69,4],[0,4]] },
      { type: 'square', vol: 0.03, notes: [[-1,4],[0,4],[-1,2],[-1,2],[0,4]] },
    ]
  },
  sad: {
    bpm: 70,
